...
<body>
	<div>
		<form:form action="${pageContext.request.contextPath}/save"
			modelAttribute="newsForm" method="POST">
			...
			<div class="qwe">
				...
				<div class="newsViewContent">
					<form:input cssClass="newsEditFields" path="title" />
			...
			<div class="qwe">
				...
				<div class="newsViewContent">
					<form:input cssClass="newsEditFields" path="date" />
			...
			<div class="qwe">
				...
				<div class="newsViewContent">
					<form:textarea cssClass="newsEditFields newsEditBrief" path="brief"></form:textarea>
			...
			<div class="qwe">
				...
				<div class="newsViewContent">
					<form:textarea cssClass="newsEditFields newsEditContent"
			...
			<div id="newsViewButtons">
				<input type="submit"
					value="<spring:message code="messages.editNews.save"/>" /> <input
					type="submit"
					value="<spring:message code="messages.editNews.cancel"/>"
